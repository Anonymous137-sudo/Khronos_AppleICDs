...
enum {
    ...
    GL_DRIVER_MAX_TEXTURE_LEVELS = 16,
    GL_DRIVER_MAX_TRANSFORM_FEEDBACK_BUFFERS = 8,
    GL_DRIVER_MAX_UNIFORM_BUFFER_BINDINGS = 8,
    GL_DRIVER_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS = 8,
    GL_DRIVER_MAX_SHADER_STORAGE_BUFFER_BINDINGS = 8
};

enum {
    GL_DRIVER_UNIFORM_BUFFER_OFFSET_ALIGNMENT = 256,
    GL_DRIVER_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT = 256
};
